...
//  AppleNewsFeed
//
//  Created by adrians.freimanis on 22/05/2023.
//
...
class NewsFeedViewController: UIViewController {
    ...
    @IBAction func extraButtonTapped(_ sender: Any) {
        ...
        basicActionSheet(title: "Share", message: "Choose where you want to share this app!")
...
extension NewsFeedViewController {
    ...
    private func basicActionSheet(title: String?, message: String?) {
        DispatchQueue.main.async {
            ...
            let action1: UIAlertAction = UIAlertAction(title: "WhatsApp", style: .default)
            let action2: UIAlertAction = UIAlertAction(title: "FaceBook", style: .default)
            let action3: UIAlertAction = UIAlertAction(title: "Instagram", style: .default)
